...
export default function CalcularIdade() {
    ...
    const calcularIdade = () =>  {
        ...
        if(mesParaAniversario < 0){
            setIdade(`Voce completou ${idadePronta} anos`)
        }else if(mesParaAniversario == 0){
            setIdade(`Parabens pelo aniversario de ${idadePronta} anos`)
        }else{
            setIdade(`Voce tem ${idadePronta - 1} anos e irá completar
                ${idadePronta} anos daqui a ${mesParaAniversario} meses`)
        }
    }
